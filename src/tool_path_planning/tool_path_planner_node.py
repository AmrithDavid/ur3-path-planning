...
class ToolPathPlannerNode(Node):
    ...
    def __init__(self):
        ...
        # Set up Canvas margins constants (inward from edges)
    ...
    def pixel_map_callback(self, msg):
        ...
        try:
            ...
            # Structure as per control requirements:
            # - splines with sequential IDs (0, 1, 2, etc.)
            # - Each spline has waypoints with [x, y] coordinates
            ...
            for i, path in enumerate(optimized_paths):
                ...
                splines.append({
                    "id": i,  # Sequential IDs starting from 0
                    "waypoints": waypoints
                })
